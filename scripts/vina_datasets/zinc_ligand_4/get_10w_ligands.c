      ...
      char *argv[])
{
   ...
   collection1 = mongoc_client_get_collection (client, "zinc_ligand_10w", "zinc_data");
    ...
    command = BCON_NEW ("enablesharding", BCON_UTF8 ("zinc_ligand_10w")
                        );
    command1 = BCON_NEW ( "shardcollection",BCON_UTF8("zinc_ligand_10w.zinc_data"),
